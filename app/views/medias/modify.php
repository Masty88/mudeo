                                        ...
                                        <form enctype="multipart/form-data"
                                            ...
                                            <div class="field" id="title-group">
                                                ...
                                                <div class="control has-icons-left has-icons-right">
                                                    <input class="input <?php echo (!empty($data['title_err'])) ? 'is-danger' : '' ?>"
                                                           id="form-email" type="text" placeholder="Title" name="title"
                                            ...
                                            <div class="field" id="body-group">
                                                ...
                                                <div class="control has-icons-left has-icons-right">
                                                    <textarea class="textarea has-text-left" name="body" id="body-post" rows="10"><?= $data['entity']->description; ?>
                                                    </textarea>
                                                </div>
