...
<section class="hero is-large is-custom is-relative">
    ...
    <div class="previewOverlay">
        <div class="mainDetails ml-6 is-flex is-flex-direction-column">
            <h2 class="title has-text-white is-1">
                <?= $data['preview']->name; ?>
            </h2>
            <h3 class="title">
            </h3>
            <div class="buttons">
                <a href="<?= URLROOT ?>/pages/show/<?= $data['preview']->id ?>"
                   class="button is-success is-medium buttonMainHero">
                                ...
                                <div class="columns" style="margin-bottom: 5px; ">
                                    <div class="column" style="margin-bottom: -10px; ">
                                        <h3 class="title is-6 has-text-white"
                                            style="max-width: 100%;margin-bottom: 5px; "><?= $list->filmName; ?></h3>
                                        <p class="has-text-white"><?= $list->view_count; ?> views </p>
                                    </div>
                                </div>
                                <div class="columns ">
                                    <div class="column mr-2 is-1 is-gapless ">
                                        <a href="<?= URLROOT ?>/pages/show/<?= $list->showId ?>"
                                           class="button button is-dark is-small">
                                    <span class="icon is-small">
                                       <i class="fas fa-play"></i>
                                    </span>
                                        </a>
                                    ...
                                    <div class="column is-gapless">
                                        <form class="watchlist" method="post">
                                            <input class="entityId" class="input" type="hidden"
                                                   value="<?= $list->showId ?>">
                                    ...
                                    <div class="column">
                                        <?php if (!isLiked($list->showId)): ?>
                                            <form class="likedList" method="post">
                                                <input class="entityIdLike" class="input" type="hidden"
                                                       value="<?= $list->showId ?>">
                                        ...
                                        <?php else : ?>
                                            <form class="unlikedList" method="post">
                                                <input class="entityIdUnLike" class="input" type="hidden"
                                                       value="<?= $list->showId ?>">
